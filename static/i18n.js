...
const LOCALES = {
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    insights_aux_tasks: 'Background Tasks',
    insights_aux_total: 'total background tokens',
    insights_aux_calls: 'calls',
    insights_aux_task: 'Task',
  ...
  folder_add_as_space_title: 'Добавить как пространство?',
    ...
    insights_aux_tasks: 'Фоновые задачи',
    insights_aux_total: 'токенов фоновых задач',
    insights_aux_calls: 'вызовов',
    insights_aux_task: 'Задача',
