...
const LOCALES = {
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    insights_usage_split: 'Chat vs Background',
    insights_usage_split_desc: 'Tokens attributed to {model} are counted as background',
    insights_chat: 'Chat',
    insights_background: 'Background',
  ...
  folder_add_as_space_title: 'Добавить как пространство?',
    ...
    insights_usage_split: 'Чат vs Фоновые задачи',
    insights_usage_split_desc: 'Токены модели {model} считаются фоновыми',
    insights_chat: 'Чат',
    insights_background: 'Фоновые',
